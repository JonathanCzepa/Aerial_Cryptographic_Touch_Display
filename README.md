...
https://glidegear.net/products/teleprompter-replacement-glass -> It appears that the best option for small beam splitter glass is teleprompter replacement glass, most of which comes in atleast 7inch sizes.

Computing Board (Pi 4B):

https://www.mouser.com/c/embedded-solutions/computing/?form%20factor=Raspberry%20Pi%204%20B&utm_id=22019481498&utm_source=google&utm_medium=cpc&utm_marketing_tactic=amercorp -> The computing board chosen was a PI4B for its ease of use and its capable I/O.

TOF Sensor: 

https://www.digikey.com/en/products/detail/stmicroelectronics/VL53L5CX-SATEL/14552430 -> These come packaged as a product of two so only one purchase is necessary. It was initially hoped that a single sensor would be able to give enough information for both row and column, but both sensors had to be used, one for row detection and another for column detection.
