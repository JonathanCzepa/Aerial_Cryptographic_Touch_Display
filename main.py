    ...
    try:
        ...
        if data:
            ...
            if hasattr(data, 'distance_mm'):
                # Convert ctypes array - take first 64 elements (for 8x8 resolution)
                dist_array = np.array(data.distance_mm[:64])
                distances = dist_array.flatten().tolist()
            elif hasattr(data, 'distance'):
                distances = np.array(data.distance[:64]).tolist()
            elif hasattr(data, 'distances'):
                distances = np.array(data.distances[:64]).tolist()
            elif hasattr(data, 'data'):
                distances = np.array(data.data[:64]).tolist()
            else:
    ...
    try:
        ...
        if data:
            ...
            if hasattr(data, 'distance_mm'):
                ...
                distances = np.array(data.distance_mm).tolist()
            elif hasattr(data, 'distance'):
                distances = np.array(data.distance).tolist()
            elif hasattr(data, 'distances'):
                distances = np.array(data.distances).tolist()
            elif hasattr(data, 'data'):
                distances = np.array(data.data).tolist()
            else:
                # Try as numpy array or list
                distances = np.array(data)
            # distances is 64-element array for 8x8 grid
